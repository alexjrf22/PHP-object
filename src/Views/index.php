...
<html lang="en">
  ...
  <body>
      <div class="container">
        ...
        ?>
        <p>
            <a href="/?ordem=ASC" class="btn btn-primary"><i class="glyphicon glyphicon-circle-arrow-up"></i></a>&nbsp;<a href="/?ordem=DESC" class="btn btn-primary"><i class="glyphicon glyphicon-circle-arrow-down"></i></a>
        </p>
